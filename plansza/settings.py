"""
Django settings for plansza project.
...
SECRET_KEY = '_xx7ykcmm(rq@s+55vf2ma5rd6jhwt&menz5+^)b7kwbd0r3zq'
...
WSGI_APPLICATION = 'plansza.wsgi.application'
